"""Package a compact, attributed research appendix; never modify lexical sources.

Run the six analysis scripts first. The resulting local files are derived
